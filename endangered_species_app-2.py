...
def main():
    ...
    We wish to inform readers that the data used in the accompanying Excel sheet for this report 
    was generated by our team with assistance from ChatGPT. Due to the unavailability of a suitable 
    real-world dataset aligned with our problem statement, we created a synthetic dataset to demonstrate 
    our concept and showcase the application of various machine learning models. As a result, the data 
    may not accurately reflect real-world conditions and should not be considered a precise representation 
    of actual endangered species statistics. The dataset serves solely as a tool to illustrate our methodology 
    and ideas. Any high accuracy or seemingly precise values in the model results are likely a consequence of 
    using this controlled, artificial data and may not translate to real-world scenarios. 
    We recommend interpreting the findings with this limitation in mind.
    </p>
    """
